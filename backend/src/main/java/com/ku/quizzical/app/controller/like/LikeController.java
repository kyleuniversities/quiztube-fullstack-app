...
public final class LikeController {
        ...
        public ResponseEntity<LikeDto> saveLike(@PathVariable String quizId,
                ...
                User matchingUser = DatabaseValidationHelper
                                .validateExistingResourceWithFallthrough("Like User", like.userId(),
                ...
                return new ResponseEntity<LikeDto>(
                                this.service.saveLike(like.userId(), quizId, like), HttpStatus.OK);
        }
        ...
        public ResponseEntity<LikeDto> likeExistsForQuizForUser(
        ...
        public String deleteLike(@PathVariable("quizId") String quizId,
                        @PathVariable("id") String id,
                        @RequestHeader("Authorization") String authorizationHeader) {
                Like matchingLike =
                                DatabaseValidationHelper.validateExistingResourceWithFallthrough(
                                                "Like", id, this.repository::findById);
                AuthorizationValidationHelper.validateAuthorization(authorizationHeader,
